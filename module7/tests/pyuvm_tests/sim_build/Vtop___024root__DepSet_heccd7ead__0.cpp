...
#endif
            VL_FATAL_MT("../../dut/dma/simple_dma.v", 17, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../../dut/dma/simple_dma.v", 17, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../dut/dma/simple_dma.v", 17, "", "Active region did not converge.");
            }
