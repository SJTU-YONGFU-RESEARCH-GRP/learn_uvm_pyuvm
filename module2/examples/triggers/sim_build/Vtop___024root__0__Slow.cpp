...
#endif
            VL_FATAL_MT("../../dut/registers/simple_register.v", 14, "", "Settle region did not converge after 100 tries");
        }
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @(posedge simple_register.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @(negedge simple_register.rst_n)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__simple_register__DOT__clk__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__simple_register__DOT__rst_n__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
